...
<head>
    ...
    <![endif]-->
    <link href='http://fonts.css.network/css?family=Open+Sans:300,400,600&subset=latin,latin-ext' rel='stylesheet'>
</head>
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input name="remember" type="checkbox" ${remember}> 自动登陆
                        </label>
                    </div>
                </div>
                <!-- /.col -->
